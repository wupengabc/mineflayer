...
function inject (bot, { physicsEnabled, maxCatchupTicks }) {
  ...
  function doPhysics () {
    ...
    if (sendsClientTickEnd) {
      // 26.1+ servers validate a real 20 Hz network cadence. Replaying missed
      // client ticks in one timer callback sends a burst of movement packets.
